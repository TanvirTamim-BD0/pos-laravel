...
<html lang="en">
    ...
    <body id="kt_body" class="bg-body">
                        ...
                        @csrf
                         ...
                         @endif
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-solid @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus />
                            </div>
        ...
        <script src="../backend/assets/js/custom/authentication/password-reset/password-reset.js"></script>
