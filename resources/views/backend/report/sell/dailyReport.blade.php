...
@section('sale-daily-report') active @endsection
@section('sale-daily-report') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Daily Sale Report List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0 mt-10">
                    ...
                    <form action="{{ route('sale-daily-report-with-date') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-5">
                                    <label for="selected_from_date" class="form-label">Select A Date</label>
                                    <div class="col-xl-12 fv-row fv-plugins-icon-container">
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            @if(isset($selectedDate))
                                                <input class="form-control form-control-solid ps-12 flatpickr-input active" name="selected_from_date" placeholder="Pick a date" id="selected_from_date" type="text" readonly="readonly" value="{{ $selectedDate }}">
                                            @else
