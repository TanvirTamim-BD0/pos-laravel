...
@section('sale-monthly-report-with-month-name') active @endsection
@section('sale-monthly-report-with-month-name') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Monthly Sale Report List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0 mt-10">
                    ...
                    <form action="{{ route('sale-monthly-report-with-month-name') }}" method="post">
                        @csrf
                        <div class="row">
