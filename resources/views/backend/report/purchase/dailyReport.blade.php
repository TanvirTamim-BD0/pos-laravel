...
@section('purchase-daily-report-with-date') active @endsection
@section('purchase-daily-report-with-date') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Purchase Daily Report List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
        ...
        <div id="kt_content_container" class="container-xxl">
             ...
             <div class="card">
                ...
                <div class="card-body pt-0 mt-10">
                    ...
                    <form action="{{ route('purchase-daily-report-with-date') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-5">
