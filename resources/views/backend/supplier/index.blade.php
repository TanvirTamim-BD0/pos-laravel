...
@section('cutomers.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Supplier List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--begin::Add customer-->
                            @can('supplier-create')
                                <a href="{{ route('supplier.create') }}" class="btn text-white"
                                    style="background-color: #2F4F4F">Add Supplier</a>
                            @endcan
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
