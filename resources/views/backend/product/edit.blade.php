            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Product Edit</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                    ...
                    <div class="card-body pt-0">
                        <form action="{{ route('product.update', $product->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        <label for="product_code" class="form-label">Product Code <span class=" text-danger">(required)</span> </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <input type="number" class="form-control" name="purchase_price"
                                            value="{{ $product->purchase_price }}" id="purchase_price" placeholder="Purchase Price" required>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <input type="number" class="form-control" name="selling_price"
                                            value="{{ $product->selling_price }}" id="selling_price" placeholder="Selling Price" required>
								...
								<div class="col-md-6">
                                    <div class="mb-5">
                                        ...
                                        <input type="text" class="form-control" name="stock_alert"
                                            value="{{ $product->stock_alert }}" id="stock_alert" placeholder="Stock Alert">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-5">
                                        ...
                                        <textarea type="text" class="form-control" name="product_details"
                                            id="description"
                                            placeholder="Enter Product Price">{{ $product->product_details }}</textarea>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px"
                                                    style="background-image: url({{ asset('uploads/product_image/' . $product->product_image) }});">
                                                </div>
