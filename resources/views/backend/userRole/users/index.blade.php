								...
								<div class="card mt-6">
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												@can('user-create')
												<a href="{{route('users.create')}}" class="btn text-white" style="background-color: #2F4F4F">Add User</a>
												@endcan
												<!--end::Add customer-->
											</div>
									...
									<div class="card-body pt-0">
													  ...
													  <tr>
														...
														@if($item->status == 1)
															<div class="menu-item px-3">
				                                              	<a href="{{ route('user-inactive',$item->id) }}" class="menu-link px-3"> <i class="las la-pen"></i><span style="margin-left: 2px;">Inactive</span> </a>
				                                             </div> 
				                                        @else
				                                        	<div class="menu-item px-3">
				                                              <a href="{{ route('user-active',$item->id) }}" class="menu-link px-3"><i class="las la-pen"></i><span style="margin-left: 2px;">Active</span> </a>
				                                            </div>  
				                                        @endif
															...
															@can('user-edit')
															<div class="menu-item px-3">
																<a href="{{route('users.edit',$item->id)}}" class="menu-link px-3"> <i class="las la-edit"></i><span style="margin-left: 2px;">Edit</span> </a>
															</div>
															@endcan
															...
															<div class="menu-item">
																...
																<form method="POST" action="{{ route('users.destroy', $item->id) }}" class="menu-link">
						                                            @csrf
						                                            @method('delete')
										...
										<div class="pagination mt-2 d-flex justify-content-center">
											  {{ $data->links('backend.userRole.users.paginate') }}
										</div>
