								...
								<div class="card mt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												@if(Auth::user()->role == 'superadmin')
													<!--end::Export-->
													<!--begin::Add customer-->
													<a href="{{route('roles.create')}}" class="btn text-white" style="background-color: #2F4F4F">Add Role</a>
													<!--end::Add customer-->
												@endif
											</div>
											@endcan
									...
									<div class="card-body pt-0">
													  ...
													  <tr>
														...
														<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
															...
															<div class="menu-item px-3">
																<a href="{{route('roles.edit',$role->id)}}" class="menu-link px-3"><i class="las la-edit"></i><span style="margin-left: 2px;">Edit</span> </a>
															</div>
															@endcan
															...
															@can('role-delete')
															<div class="menu-item">
																<form method="POST" action="{{ route('roles.destroy', $role->id) }}" class="menu-link">
						                                            @csrf
						                                            @method('delete')
										...
										<div class="pagination mt-2 d-flex justify-content-center">
											  {{ $roles->links('backend.userRole.roles.paginate') }}
										</div>
