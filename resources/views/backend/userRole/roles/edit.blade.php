																			...
																			<tr class="allInput">
																				...
																				<td class="text-gray-800 d-flex">{{ $group->name }} <label class="form-check form-check-sm form-check-custom form-check-solid" style="margin-left: 5px;" for="{{ $i }}Management">
																					    <input class="form-check-input" type="checkbox"
																							 name="permissions[]" id="{{ $i }}Management" onclick="checkPermissionByGroup('role-{{$i}}-management-checkbox', this)" {{ App\Models\User::roleHasPermissions($role, $all_permissions) ? 'checked' : '' }} />
																				...
																				<td>
																					...
																					<div class="role-{{ $i }}-management-checkbox">
																						...
																						<label class="form-check form-check-sm form-check-custom form-check-solid me-2 me-lg-20 mt-1" for="{{$permission->id}}">
																							 ...
																							 <input class="form-check-input" type="checkbox" name="permission[]" value="{{$permission->id}}" id="{{$permission->id}}" {{ $role->hasPermissionTo($permission->name) ? 'checked' : '' }}>
