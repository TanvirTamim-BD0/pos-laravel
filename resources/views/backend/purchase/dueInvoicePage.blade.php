        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Purchase Due Invoice</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        <li class="breadcrumb-item text-muted">Purchase Due Invoice</li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
        ...
        <div class="modal" id="kt_modal_new_address" tabindex="-1" aria-modal="true" role="dialog">
            ...
            <div class="modal-dialog modal-dialog-centered mw-750px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                   <form method="post" action="{{route('purchase-due-payment')}}">
                    @csrf
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_new_address_header">
                            <!--begin::Modal title-->
                            <h2>Purchase Due Payment</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_new_address_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_new_address_header" data-kt-scroll-wrappers="#kt_modal_new_address_scroll" data-kt-scroll-offset="300px" style="max-height: 163px;">
                                    ...
                                    <input type="hidden" value="{{ $purchaseData->id }}" name="purchase_id">
...
<!--             <div id="print-area">
                ...
                <div class="bill-date">
                    <div class="bill-no">
                        Invoice No: {{ $purchaseData->purchase_id }}
                    </div>
                    <div class="date">
                        Date: <strong>{{ $purchaseData->created_at->toDateString() }}</strong>
                    </div>
                </div>
                ...
                <div class="address">
                    Address : <span>{{ $supplierData->supplier_address }}</span>
                </div>

                <div class="mobile-no">
                    Mobile : <span>{{ $supplierData->supplier_phone }}</span>
                </div>
                ...
                <table class="table table-bordered table-plist my-3 order-details">
                    <tbody>
                        ...
                        <tr>
                             @foreach($purchaseProducts as $key=>$productData)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $productData->free_product }}</td>
                                    <td>{{ $productData->total_product }}</td>
                                    <td class="fw-bolder text-gray-800">{{ $productData->total_product_price }}</td>
                                </tr>
                                @endif
                            @endforeach
                        </tr>
                        ...
                        <tr>
                            <td colspan="5" style="margin-right: 100px;">Due : </td>
                            <td>
            ...
            <a href="{{route('purchase.index')}}" class="btn btn-primary btn-block" style="margin-bottom: 30px;">
            ...
            <table class="table table-bordered table-plist my-3 order-details">
                    <tbody>
                        ...
                        @foreach($purchaseDuePaymentHistroy as $purchaseDuePayment)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td>{{ $purchaseDuePayment->due_amount }}</td>
                            <td>{{ $purchaseDuePayment->date }}</td>
                        </tr>
                        @endforeach
