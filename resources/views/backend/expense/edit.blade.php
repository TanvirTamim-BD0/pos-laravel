							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Expense Edit</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
								...
								<div class="card">
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												@can('expense-list')
												<a href="{{route('expense.index')}}" class="btn text-white" style="background-color: #2F4F4F">Expenses List</a>
												@endcan
									...
									@method('put')	
										<div class="row">
											...
											<div class="col-md-6">
												<div class="mb-5">
												 	<label for="expense_category_id" class="form-label">Expence Category</label>
												  	<select class="form-select" name="expense_category_id" data-control="select2" data-placeholder="Select Expence Category">
													    <option></option>
													    @foreach($expenseCategories as $expenseCategory)
													    <option value="{{$expenseCategory->id}}" {{$expenseCategory->id == $expense->expense_category_id ? "selected":""}} >{{$expenseCategory->expense_category}}</option>
													    @endforeach
													</select>
											...
											<div class="col-md-6">
												<div class="mb-5">
												  <label for="expense_name" class="form-label">Expence Name</label>
												  <input type="Text" class="form-control" name="expense_name" id="expense_name" placeholder="Expence Name" value="{{$expense->expense_name}}">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="mb-5">
												  ...
												  <input type="number" class="form-control" name="amount" id="amount" placeholder="Amount" value="{{$expense->amount}}">
			                                    ...
			                                    <div class="mb-5">
			                                        ...
			                                        <div class="col-xl-12 fv-row fv-plugins-icon-container">
			                                            <div class="position-relative d-flex align-items-center">
			                                                ...
			                                                <input class="form-control ps-12 flatpickr-input active" name="date" placeholder="Pick a date" id="date" type="text" readonly="readonly" value="{{$expense->date}}">
			                                            </div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="mb-5">
												  ...
												  <textarea type="text" class="form-control" name="description" id="description" placeholder="Description">{{ $expense->description }}</textarea>
