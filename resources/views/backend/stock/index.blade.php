...
@section('stock.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Stocks List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                            ...
                            <tbody class="fs-6 fw-bold text-gray-600">
                                @foreach($stocks as $stock)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('/uploads/product_image/'.$stock->productData->product_image) }}"
                                                width="55" height="45"></td>
										<td>{{ $stock->productData->product_name }}</td>
                                        <td>
											<span class="badge badge-light-primary fw-bolder">
												{{ $stock->productData->product_code }}
											</span>
										</td>
                                        <td>
