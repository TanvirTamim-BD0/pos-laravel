                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <a href="{{ route('customers.index') }}" class="btn text-white"
                                    style="background-color: #2E8B57">Reset</a>
                            </div>
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--begin::Add customer-->
                            @can('customer-create')
                                <a href="{{ route('customers.create') }}" class="btn text-white"
                                    style="background-color: #2F4F4F">Add Customer</a>
                            @endcan
                            <!--end::Add customer-->
                        </div>
                        <!--end::Toolbar-->
                                                        ...
                                                        <div class="menu-item">
                                                            <a href="{{ route('customers.edit',$customer->id) }}"
                                                                class="menu-link px-6"><i
                                                                    class="las la-edit"></i><span>Edit</span></a>
                                                        </div>
                                                    @endcan
