...
@section('content')
@section('title') Damage Edit @endsection
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Damage</h1>
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-muted">Damage Edit</li>
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item">
											<span class="bullet bg-gray-300 w-5px h-2px"></span>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												@can('damage-list')
												<a href="{{route('damage.index')}}" class="btn text-white" style="background-color: #2F4F4F">Damage List</a>
												@endcan
									...
									<div class="card-body pt-0">
									 ...
									 @method('put')
										<div class="row">
											...
											<div class="col-md-6">
												<div class="mb-5">
												 	<label for="product_id" class="form-label">Product <span class=" text-danger">(required)</span> </label>
												  	<select class="form-select" name="product_id" id="product_id" data-control="select2" data-placeholder="Select Product">
													     <option></option>
													    @foreach($products as $product)
													    <option value="{{$product->id}}" {{$product->id == $damage->product_id ? "selected":""}}>{{$product->product_name}}</span> </option>
													    @endforeach
											...
											<div class="col-md-6">
												<div class="mb-5">
												  <label for="damage_qty" class="form-label">Quantity <span class=" text-danger">(required)</span> </label>
												  <input type="number" class="form-control" name="damage_qty" id="damage_qty" placeholder="Quantity" value="{{$damage->damage_qty}}">
										 ...
										 <div class="col-md-6">
			                                    <div class="mb-5">
			                                        ...
			                                        <div class="col-xl-12 fv-row fv-plugins-icon-container">
			                                            <div class="position-relative d-flex align-items-center">
			                                                ...
			                                                <input class="form-control ps-12 flatpickr-input active" name="date" placeholder="Pick a date" id="date" type="text" readonly="readonly" value="{{$damage->date}}">
			                                            </div>
			                                        <div class="fv-plugins-message-container invalid-feedback"></div></div>

			                                        <input type="hidden" class=" form-control form-control-solid ps-12 flatpickr-input" name="dfd" id="df">
											...
											<div class="col-md-12">
												<div class="mb-5">
												  <label for="product_price" class="form-label">Note</label>
												  <textarea type="text" class="form-control" name="note" id="description" placeholder="Note">{{$damage->note}}</textarea>
