...
@section('unit') active @endsection
@section('unit.index') active @endsection
@section('styles')
@endsection
@section('content')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Unit List</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <!--begin::Add customer-->
                            @can('unit-create')
                                <a href="{{ route('unit.create') }}" class="btn text-white"
                                    style="background-color: #2F4F4F">Add Unit</a>
                            @endcan
												...
												<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                    ...
                                                    @can('unit-edit')
                                                        <div class="menu-item">
                                                            ...
                                                            @if($unit->is_default == true)
                                                                <a href="{{ route('unit-inactive',$unit->id) }}"
                                                                    class="menu-link px-6"><i class="las la-times"></i><span
                                                                        >Secondary</span> </a>
                                                            @else
                                                                <a href="{{ route('unit-active',$unit->id) }}"
                                                                    class="menu-link px-6"><i class="las la-check"></i><span
                                                                        >Primary</span> </a>
                                                            @endif
                                                        </div>
                                                        <div class="menu-item">
