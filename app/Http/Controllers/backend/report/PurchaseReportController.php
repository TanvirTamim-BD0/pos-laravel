...
class PurchaseReportController extends Controller
{
   //To fetch user id...
    ...
    public function purchaseTodaysReport()
    {
       //To get user id..
        ...
        ->whereDate('created_at', $todayDate)->where('purchase_status',1)->get();
        ...
        return view('backend.report.purchase.todayReport', compact('purchaseData','totalProductPrice','paidAmount','dueAmount'));
    }
    ...
    public function currentWeekendReport()
    {
        ...
        //To fetch all the selling data from table...
        $purchaseData = Purchase::orderBy('id', 'desc')->where('user_id', $userId)
        ->whereDate('created_at', '>=', $selectedDate)->where('purchase_status',1)->get();
        ...
        return view('backend.report.purchase.currentWeekendReport', compact('purchaseData','totalProductPrice','paidAmount','dueAmount'));
    }
    ...
    public function currentMonthReport()
    {
        ...
        return view('backend.report.purchase.currentMonthReport', compact('purchaseData','totalProductPrice','paidAmount','dueAmount'));
    }
    ...
    public function dailyReport()
    {
       //To get user id..
        ...
        return view('backend.report.purchase.dailyReport', compact('purchaseData','totalProductPrice','paidAmount','dueAmount'));
    }
   ...
   //To fetch all the selling reports of current month...
    public function monthlyReport()
    {
        ...
        return view('backend.report.purchase.monthlyReport', compact('purchaseData','totalProductPrice','paidAmount','dueAmount','monthNames','years'));
    }
    ...
    public function monthlyReportWithMonthName(Request $request)
    {
        ...
        //To fetch all the selling data from table...
        $purchaseData = Purchase::orderBy('id', 'desc')->where('user_id', $userId)
         ->whereYear('created_at', $selectedYear)->whereMonth('created_at', $currentMonth)->where('purchase_status',1)->get();
   ...
   //To fetch report with current date...
    public function reportWithBetweenDates()
    {
        ...
        return view('backend.report.purchase.betweenWithDatesReport', compact('purchaseData','totalProductPrice','paidAmount','dueAmount'));
    }
    ...
    public function reportWithBetweenTwoDates(Request $request)
    {
        ...
        //To fetch all the selling data from table...
        $purchaseData = Purchase::orderBy('id', 'desc')->where('user_id', $userId)
        ->whereBetween('created_at', [$selectedFromDate,$selectedToDate])->where('purchase_status',1)->get();
